...
const ManageParticipantsPlanIdRoute =
  ManageParticipantsPlanIdRouteImport.update({
    id: '/manage-participants/$planId',
    path: '/manage-participants/$planId',
    getParentRoute: () => rootRouteImport,
  } as any).lazy(() =>
    import('./routes/manage-participants.$planId.lazy').then((d) => d.Route)
  );
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/manage-participants/$planId': {
      id: '/manage-participants/$planId';
      path: '/manage-participants/$planId';
      fullPath: '/manage-participants/$planId';
      preLoaderRoute: typeof ManageParticipantsPlanIdRouteImport;
      parentRoute: typeof rootRouteImport;
    };
    '/items/$planId': {
      id: '/items/$planId';
